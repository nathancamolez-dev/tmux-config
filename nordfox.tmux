...
# Change the status bar color when entering command mode
set -g status-style "fg=#abb1bb,bg=#232831"  # Default status style

# Hook to change the status bar color when entering command mode
bind -n C-a set -g status-style "fg=red,bg=#232831"  # Change to red when in command mode
bind -n C-a if-shell -F "#{?client_prefix,1,0}" "set -g status-style 'fg=#abb1bb,bg=#232831'" "set -g status-style 'fg=red,bg=#232831'"  # Reset to default after command mode
